...
//========================================================================================
	...
	Flux<User> fromFlowableToFlux(Flowable<User> flowable) {
		return Flux.from(flowable).log();
	}

//========================================================================================

	// TODO Adapt Flux to RxJava Observable(Convert to flowable then to observable)
	Observable<User> fromFluxToObservable(Flux<User> flux) {
		return Flowable.fromPublisher(flux).toObservable();
	}

	// TODO Adapt RxJava Observable to Flux(convert from observable to flowable then to flux)
