...
//========================================================================================
	...
	// TODO Create a Flux for reading all users from the blocking repository (e.g. JDBC) deferred until the flux is subscribed, and run it with an elastic scheduler
